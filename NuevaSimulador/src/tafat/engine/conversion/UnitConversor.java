...
public class UnitConversor {
	...
	public UnitConversor() {
		...
		conversionMap.put("s-m", 1/60);
		conversionMap.put("m-s", 60);
		conversionMap.put("s-h", 1/3600);
		conversionMap.put("h-s", 3600);
		conversionMap.put("m-h", 1/60);
		conversionMap.put("h-m", 60);
	}
